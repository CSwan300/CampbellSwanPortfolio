...
const About = () => {
    return (
        <section id="about" className="py-16 bg-gradient-to-b from-slate-800 to-slate-900 text-white">
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="space-y-4">
                            <h3 className="text-2xl font-semibold text-purple-300">Skills & Interests</h3>
                            <ul className="grid grid-cols-2 gap-3">
                                {['Puzzles', 'Chess', 'Python', "Rugby",'Data Analysis', 'Backend Development', 'Problem Solving', 'Git & GitHub', 'Golf'].map((skill, index) => (
                                    <li
                                        key={index}
                    ...
                    <div className="relative">
                        ...
                        <div className="relative bg-slate-700 p-8 rounded-lg border border-blue-500/30">
                            <h3 className="text-2xl font-semibold mb-6 text-purple-300">By The Numbers</h3>
                            <div className="space-y-4">
